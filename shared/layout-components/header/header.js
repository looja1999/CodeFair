			...
			<div className="main-container container-fluid">
				<div className="main-header-left">
					...
					<div className="hor-logo">
						<a className="main-logo" href="#">
							<img src="../assets/img/brand/logo.png" className="header-brand-img desktop-logo" alt="logo"></img>
							<img src="../assets/img/brand/logo-light.png" className="header-brand-img desktop-logo-dark"
								alt="logo"></img>
						</a>
					</div>
				</div>
				<div className="main-header-center">
					<div className="responsive-logo">
						<a href="#"><img src="../assets/img/brand/logo.png" className="mobile-logo" alt="logo"></img></a>
						<a href="#"><img src="../assets/img/brand/logo-light.png" className="mobile-logo-dark"
								alt="logo"></img></a>
					</div>
									...
									<div className="dropdown-menu">
										<div className="main-form-search p-2">
											<div className="input-group">
												...
												<button className="btn search-btn"><svg xmlns="http://www.w3.org/2000/svg" style={{width: "20" ,height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round" }} className="feather feather-search">
									...
									<div className="dropdown-menu">
										<a href="#" className="dropdown-item d-flex ">
											<span className="avatar  me-3 align-self-center bg-transparent"><img
													src="../assets/img/flags/french_flag.jpg" alt="img"></img></span>
										...
										<a href="#" className="dropdown-item d-flex">
											<span className="avatar  me-3 align-self-center bg-transparent"><img
													src="../assets/img/flags/germany_flag.jpg" alt="img"></img></span>
											<div className="d-flex">
										...
										<a href="#" className="dropdown-item d-flex">
											<span className="avatar me-3 align-self-center bg-transparent"><img
													src="../assets/img/flags/italy_flag.jpg" alt="img"></img></span>
											<div className="d-flex">
										...
										<a href="#" className="dropdown-item d-flex">
											<span className="avatar me-3 align-self-center bg-transparent"><img
													src="../assets/img/flags/russia_flag.jpg" alt="img"></img></span>
											<div className="d-flex">
										...
										<a href="#" className="dropdown-item d-flex">
											<span className="avatar  me-3 align-self-center bg-transparent"><img
													src="../assets/img/flags/spain_flag.jpg" alt="img"></img></span>
											<div className="d-flex">
									...
									<div className="dropdown-menu">
										<div className="header-navheading">
											<p className="main-notification-text">You have 1 unread notification<span
													className="badge bg-pill bg-primary ms-3">View all</span></p>
										</div>
										<div className="main-notification-list">
											<div className="media new">
												<div className="main-img-user online"><img alt="avatar"
														src="../assets/img/users/5.jpg"></img></div>
											...
											<div className="media">
												<div className="main-img-user"><img alt="avatar"
														src="../assets/img/users/2.jpg"></img>
												</div>
												<div className="media-body">
											...
											<div className="media">
												<div className="main-img-user online"><img alt="avatar"
														src="../assets/img/users/3.jpg"></img></div>
												<div className="media-body">
								...
								<div className="dropdown main-profile-menu">
									<a className="d-flex" href="#">
										<span className="main-img-user"><img alt="avatar"
												src="../assets/img/users/1.jpg"></img></span>
									</a>
									<div className="dropdown-menu">
										<div className="header-navheading">
